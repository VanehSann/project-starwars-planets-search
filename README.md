...
<p align="center"><b>
 ...
 <a href="#-starwars-planets-search-project-------">README em Português 🇧🇷</a>
  </b>
</p>
<h1 align="center">
...
Nesse projeto criado uma lista de filtros para pesquisas planetas de startwars e foi usado o Context API do React para gerenciar o estado, e o React Hook ( useState, useContext, useEffect e react hoocks customizados ). 
        </p> </tr>
    <tr>
      <td><br>
        <p align="left">
...
Tecnologias utilizadas ( Hard Skills )
 ...
 - JSX
  ...
  <tr><td> 
 - React: ContextAPI e React Hook ( useState, useContext, useEffect e react hoocks customizados ).
 </td></tr>
   <tr><td> 
